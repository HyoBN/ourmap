...
//            return "post/newForm";
//        } else if (postService.lengthOver(form)) {
//            model.addAttribute("msg", "0~20글자의 가게명을 입력해주세요.");
//            return "post/newForm";
//        }
//        MemberForm memberForm = (MemberForm) httpSession.getAttribute("member");
//        Member member = memberService.findMemberByEmailAndProvider(memberForm.getEmail(), memberForm.getProvider());
...
//        if(tipService.isExistTip(tip.getComment())){
//            model.addAttribute("msg", "동일한 내용의 tip이 이미 존재합니다.");
//            return "basic/mainPage";
//        } else if (tipService.lengthOver(tip.getComment())) {
